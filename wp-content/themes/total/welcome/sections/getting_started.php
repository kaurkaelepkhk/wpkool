<div class="getting-started-top-wrap clearfix">
	...
	<div class="theme-image">
		...
		<div class="theme-import-demo">
			...
			?>
			<p><?php echo sprintf(esc_html__('Or you can import the demo with just one click. It is recommended to import the demo in the fresh WordPress install. Or you can reset the website using %s plugin.', 'total'), '<a target="_blank" href="https://wordpress.org/plugins/wordpress-reset/">WordPress Reset</a>'); ?></p>
			<p><?php echo esc_html__('Click on the button below to install and activate demo import plugin.', 'total'); ?></p>
